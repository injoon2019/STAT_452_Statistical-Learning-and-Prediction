...
testx1 = rnorm(n=1000)
testx = cbind(testx1, matrix(0, ncol=9, nrow=length(testx1)))
testx.all = cbind(testx1, matrix(rnorm(n=9*length(testx1)), ncol=9, nrow=length(testx1)))
colnames(testx) = c("X1", "X2", "X3", "X4", "X5", "X6", "X7", "X8", "X9", "X10")
